...
# ///
"""
First Breath — Deterministic sanctum scaffolding for nebu-agent-testing.
...
def main():
    parser = argparse.ArgumentParser(
        description="First Breath — scaffolds the nebu-agent-testing sanctum."
    )
    ...
    for template_name in TEMPLATE_FILES:
        ...
        (sanctum_path / output_name).write_text(
            substitute_vars(template_path.read_text(), variables)
        )
    ...
    print(json.dumps({
        ...
        "next_step": "Run /nebu-agent-testing to begin First Breath",
    }, indent=2))
