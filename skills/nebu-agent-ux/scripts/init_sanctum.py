...
# ///
"""
First Breath — Deterministic sanctum scaffolding for nebu-agent-ux.
...
def main():
    parser = argparse.ArgumentParser(
        description="First Breath — scaffolds the nebu-agent-ux sanctum."
    )
    ...
    print(json.dumps({
        ...
        "next_step": "Run /nebu-agent-ux to begin First Breath",
    }, indent=2))
