...
| [ADR-010](adr/ADR-010-fts-strategy.md) | Full-Text Search Strategy | Proposed | — |
...
ADR-010 (FTS strategy) and ADR-011 (Managed E2EE) are pending because they require additional
investigation and community input before the design can be finalized.
